...
{
    rightV[0]=up[1]*direction[2]-up[2]*direction[1];
    rightV[1]=up[2]*direction[0]-up[0]*direction[2];
    rightV[2]=up[0]*direction[1]-up[1]*direction[0];
}
//_____________________________________________________________________________
...
void init(int argc, char** argv)
{
	...
	// XML Loading
	int returned = readXML(XML_FILE, MAPS, ELEMENTS);
