 ...
 * RobotState.hpp created in 09 2008.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_SMASHSTEIN__ROBOTSTATE_HPP__
#define __OPENKN_SMASHSTEIN__ROBOTSTATE_HPP__
...
namespace kn
{
    ...
    /**
     * \brief Interface class for robotstates
     */
		class RobotState
		{
			public : 
				...
				virtual const kn::Vector3f & getVelocity()const=0;

				virtual const kn::Vector3f & getDirection() const=0 ;
				
				virtual const kn::Vector3f & getPosition() const=0 ;
				
				virtual const kn::Vector3f & getRotation() const=0;
				
				virtual const int & getDamages() const=0;

				virtual const bool & isJumping() const=0;
		};
